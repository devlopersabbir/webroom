...
import { isValidFileTransferMessage, FileTransferSignalingMessage } from "../file-transfer/file-transfer-protocol";
...
export function isValidWebRoomMessage(
  ...
  return (
    ...
    isValidFileTransferMessage(payload, expectedRoomId)
  );
}
